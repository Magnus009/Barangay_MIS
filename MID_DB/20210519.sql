...
CREATE TABLE dbo.CasesHeader
	...
	InchargeID   NVARCHAR (10),
	InCharge     VARCHAR (50) NOT NULL,
	ReportedByID NVARCHAR (10),
...
VALUES (1, 1, '365', '77', '36', '58', '2021-05-19 14:57:42.02', '2021-05-19 14:57:42.02', NULL, '')
GO

INSERT INTO dbo.LotPosition (LotID, LotNo, X, Y, Width, Height, CreatedDate, UpdatedDate, DeletedDate, UpdatedBy)
VALUES (2, 1, '725', '108', '45', '90', '2021-05-19 14:57:50.973', '2021-05-19 14:57:50.973', NULL, '')
GO

INSERT INTO dbo.LotPosition (LotID, LotNo, X, Y, Width, Height, CreatedDate, UpdatedDate, DeletedDate, UpdatedBy)
VALUES (3, 1, '551', '221', '55', '48', '2021-05-19 14:57:59.783', '2021-05-19 14:57:59.783', NULL, '')
GO

INSERT INTO dbo.LotPosition (LotID, LotNo, X, Y, Width, Height, CreatedDate, UpdatedDate, DeletedDate, UpdatedBy)
VALUES (4, 1, '779', '399', '88', '74', '2021-05-19 14:58:07.95', '2021-05-19 14:58:07.95', NULL, '')
GO

INSERT INTO dbo.LotPosition (LotID, LotNo, X, Y, Width, Height, CreatedDate, UpdatedDate, DeletedDate, UpdatedBy)
VALUES (5, 1, '356', '273', '39', '34', '2021-05-19 14:58:16.827', '2021-05-19 14:58:16.827', NULL, '')
GO

INSERT INTO dbo.LotPosition (LotID, LotNo, X, Y, Width, Height, CreatedDate, UpdatedDate, DeletedDate, UpdatedBy)
VALUES (6, 1, '437', '212', '23', '39', '2021-05-19 15:09:00.31', '2021-05-19 15:09:00.31', NULL, '')
GO

INSERT INTO dbo.LotPosition (LotID, LotNo, X, Y, Width, Height, CreatedDate, UpdatedDate, DeletedDate, UpdatedBy)
VALUES (7, 1, '507', '322', '87', '24', '2021-05-19 15:10:54.75', '2021-05-19 15:10:54.75', NULL, '')
GO

INSERT INTO dbo.LotPosition (LotID, LotNo, X, Y, Width, Height, CreatedDate, UpdatedDate, DeletedDate, UpdatedBy)
VALUES (8, 1, '745', '218', '61', '71', '2021-05-19 15:12:02.827', '2021-05-19 15:12:02.827', NULL, '')
GO
...
VALUES (1, 1, '1100', 1, '2021-05-19 14:57:48.013', NULL, '2021-05-19 14:57:48.013', '')
GO

INSERT INTO dbo.Mapping (LotID, LotNo, HouseNo, HouseholdNo, CreatedDate, DeletedDate, UpdatedDate, UpdatedBy)
VALUES (2, 1, '1111', 2, '2021-05-19 14:57:56.513', NULL, '2021-05-19 14:57:56.513', '')
GO

INSERT INTO dbo.Mapping (LotID, LotNo, HouseNo, HouseholdNo, CreatedDate, DeletedDate, UpdatedDate, UpdatedBy)
VALUES (3, 1, '1112', 3, '2021-05-19 14:58:04.713', NULL, '2021-05-19 14:58:04.713', '')
GO

INSERT INTO dbo.Mapping (LotID, LotNo, HouseNo, HouseholdNo, CreatedDate, DeletedDate, UpdatedDate, UpdatedBy)
VALUES (4, 1, '1112', 4, '2021-05-19 14:58:13.977', NULL, '2021-05-19 14:58:13.977', '')
GO

INSERT INTO dbo.Mapping (LotID, LotNo, HouseNo, HouseholdNo, CreatedDate, DeletedDate, UpdatedDate, UpdatedBy)
VALUES (5, 1, '1115', 5, '2021-05-19 14:58:21.403', NULL, '2021-05-19 14:58:21.403', '')
GO

INSERT INTO dbo.Mapping (LotID, LotNo, HouseNo, HouseholdNo, CreatedDate, DeletedDate, UpdatedDate, UpdatedBy)
VALUES (6, 1, '1111', 2, '2021-05-19 15:09:09.43', NULL, '2021-05-19 15:09:09.43', '')
GO

INSERT INTO dbo.Mapping (LotID, LotNo, HouseNo, HouseholdNo, CreatedDate, DeletedDate, UpdatedDate, UpdatedBy)
VALUES (7, 1, '1112', 3, '2021-05-19 15:11:00.6', NULL, '2021-05-19 15:11:00.6', '')
GO

INSERT INTO dbo.Mapping (LotID, LotNo, HouseNo, HouseholdNo, CreatedDate, DeletedDate, UpdatedDate, UpdatedBy)
VALUES (8, 1, '1115', 5, '2021-05-19 15:12:08.213', NULL, '2021-05-19 15:12:08.213', '')
GO

INSERT INTO dbo.Mapping (LotID, LotNo, HouseNo, HouseholdNo, CreatedDate, DeletedDate, UpdatedDate, UpdatedBy)
VALUES (9, 1, '1112', 4, '2021-05-19 15:17:39.323', NULL, '2021-05-19 15:17:39.323', '')
GO
...
VALUES ('RS21040001', 'Galang', 'Renato', 'Cruz', 'JR', 'M', '1940-11-02', 'Cavite City', 'Filipino', 1, '(+63)923-758-2523', 'Fisherman', 2, 1, 1, 0, 0, '', 0, NULL, NULL, '2021-04-02 23:23:40.133', NULL, '2021-04-16 07:10:31.35', '')
GO
...
VALUES (@userid, @questionid1, @answer1, @questionid2, @answer2, @createddate, @updateddate, @deleteddate, @updatedby)
